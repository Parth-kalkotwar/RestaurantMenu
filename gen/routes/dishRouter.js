...
dishRouter
  ...
  .put(
    ...
    (req, res, next) => {
      res.statusCode = 403;
      res.end("<html><body><h1>PUT REquest Not Supported</h1></body></html>");
    }
  )
  .delete(
    cors.corsOptions,
          ...
          (dish) => {
            if (
              ...
              if (
                ...
                res.statusCode = 403;
                res.end("You Aren't Allowed to Update Others Comments");
              }
            } else if (dish == null) {
              err = new Error("Dish " + req.params.dishId + " not found");
              err.status = 404;
          ...
          (dish) => {
            if (
              ...
              if (
                ...
                res.statusCode = 403;
                res.end("You can't Delete Others Comments");
              }
            } else if (dish == null) {
              err = new Error("Dish " + req.params.dishId + " not found");
              err.status = 404;
